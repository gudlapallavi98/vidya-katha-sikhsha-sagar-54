      ...
      if (requestData && newStatus === 'accepted') {
        ...
        try {
          await fetch("https://nxdsszdobgbikrnqqrue.supabase.co/functions/v1/send-email/schedule-notification", {
            ...
            body: JSON.stringify({
              teacherEmail: requestData.teacher.email,
              teacherName: `${requestData.teacher.first_name} ${requestData.teacher.last_name}`,
              studentEmail: requestData.student.email,
              studentName: `${requestData.student.first_name} ${requestData.student.last_name}`,
