...
import { Layout, BookOpen, Calendar, Clock, Users, Settings, CalendarClock } from "lucide-react";
...
const TeacherDashboardSidebar: React.FC<TeacherDashboardSidebarProps> = ({
  ...
  const navItems = [
    ...
    { id: "availability", label: "Set Availability", icon: <CalendarClock className="h-4 w-4" /> },
